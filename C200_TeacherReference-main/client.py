...
class GUI:
    def __init__(self):
        ...
        self.entryName.place(relheight=0.122, relx=0.3, rely=0.2, relwidth=0.4)

        self.entryName.focus()

        self.go = Button(self.login, text='CONTINUE', justify = CENTER, font = 'Helvetica 14 bold', command=lambda:self.goAhead(self.entryName.get())) 
